...
**Fixed Optimized Layouts (Nov 5, 2025):** Replaced draggable GridDashboard system with fixed, optimized Flexbox layouts for consistent user experience. All panels have fixed proportions and positions for optimal single-viewport display.
**Key Layouts:**
- **Perpetuals Tab:** Fixed 3-column layout - Trading Chart (58% width), Trading Actions Panel with tabs (25% width), Order Book (17% width). Includes MarketSelector toolbar for symbol selection.
