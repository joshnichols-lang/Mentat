...
**Design System:** Glassmorphic dark trading terminal with orange/amber/gold/sepia palette. Features frosted glass effects with backdrop blur (blur(20px)), semi-transparent backgrounds (rgba opacity 0.6-0.8), gradient overlays (orange → amber → gold), and glow effects on interactive elements. Dark brown/black backgrounds (hsl(18 33% 8%)), orange primary (#B06000 / hsl(33 100% 35%)), yellow for longs (#FFC107 / hsl(45 100% 51%)), red for shorts (#F54E2E / hsl(9 84% 57%)). Modern Roboto typography, rounded corners (8px). Custom glassmorphism utilities: `.glass`, `.glass-strong`, `.gradient-border`, `.glow-orange`, `.glow-amber`, `.glow-gold`, shimmer animations.
