...
const themeColors = {
  fox: {
    dark: {
      ...
      upColor: "#FFC107",
      downColor: "#F54E2E",
      profitZone: "rgba(34, 197, 94, 0.15)",
      lossZone: "rgba(239, 68, 68, 0.15)",
      strikePrice: "rgba(147, 197, 253, 0.6)",
      breakevenPoint: "#FFC107",
      text: "#9ca3af",
    },
    light: {
